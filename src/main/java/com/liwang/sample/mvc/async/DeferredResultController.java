...
public class DeferredResultController {
    ...
    private final Queue<DeferredResult<String>> responseBodyQueue = new ConcurrentLinkedDeque<DeferredResult<String>>();

    private final Queue<DeferredResult<ModelAndView>> mavQueue = new ConcurrentLinkedDeque<DeferredResult<ModelAndView>>();

    private final Queue<DeferredResult<String>> exceptionQueue = new ConcurrentLinkedDeque<DeferredResult<String>>();
